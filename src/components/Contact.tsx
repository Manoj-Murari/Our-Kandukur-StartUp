...
const Contact: React.FC = () => {
    ...
    const contactInfo = [
        ...
        { icon: Phone, title: 'Phone', value: '+91 9381141407', link: 'tel:+919381141407' },
        { icon: MapPin, title: 'Address', value: 'Kandukur, Nellore District, Andhra Pradesh, India', link: '#' }
    ];

    const handlePartnerClick = () => {
        if (user) {
            // Maybe redirect to a partner dashboard or show a message
                ...
                <div className="mt-16 bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl p-8 text-center text-white">
                    <div className="max-w-3xl mx-auto">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            {/* UPDATED: This is now a link to the Google Form */}
                            <a 
                                href="https://docs.google.com/forms/d/e/1FAIpQLScYxDqb_KLg-rIUKKd6YAHI7lhV3jQRfXEtTbxCd3ylunafkg/viewform" 
                                target="_blank" 
                            ...
                            {/* This button still handles the partner sign-in */}
                            <button onClick={handlePartnerClick} className="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-blue-600 transition-colors">
                                Partner with Us
                            </button>
                        </div>
                    </div>
