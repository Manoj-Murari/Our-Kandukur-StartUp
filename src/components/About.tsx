...
import Partners from './Partners'; // 1. Import the new Partners component
    ...
    return (
        <section className="py-16 bg-gray-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="bg-white rounded-xl p-8 shadow-xl shadow-blue-500/10 mb-16 transition-all duration-300 hover:shadow-blue-500/20 hover:shadow-2xl hover:-translate-y-1">
                    ...
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <p className="text-lg text-gray-600 leading-relaxed">
                            Based in Kandukur, Nellore District, Andhra Pradesh, we have successfully created a network of opportunities that connects talented students with leading companies and organizations across India.
                        </p>
                    </div>
                </div>
                ...
                {/* 2. Add the Partners component here */}
                <Partners />
